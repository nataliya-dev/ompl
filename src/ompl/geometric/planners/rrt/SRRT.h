#ifndef OMPL_GEOMETRIC_PLANNERS_RRT_SRRT_
#define OMPL_GEOMETRIC_PLANNERS_RRT_SRRT_
...
namespace ompl
{
    namespace geometric
    {
        ...
        */
        ...
        class SRRT : public base::Planner
        {
        public:
            /** \brief Constructor */
            SRRT(const base::SpaceInformationPtr &si, bool addIntermediateStates = false);
